...
- Form styling in style.css—use `.form-container`, `.form-group` classes
...
3. Link to new page in style.css if styling needed

### Database Issues
- Test connection: Check db.php localhost/root credentials match XAMPP setup
